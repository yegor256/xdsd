...
\section*{\enru{What History Says}{Что говорит опыт?}}
    ...
    \marginnote{\color{tpcBlack}\input{drawings/methodologies.tex}}
    \enru{
...
\section*{\enru{An Ideal XDSD Implementation}{Пример внедрения}}
    ...
    \parpic(10em,13em)(-10em,7em){\input{drawings/costs.tex}}
    ...
    \parpic(11em,9em)(-14em,9em){\input{drawings/defects.tex}}
    ...
    \parpic(9em,7em)(-11em,6em){\input{drawings/mosaic.tex}}
